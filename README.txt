...
[I]В публичный репозиторий отправляются только исходники, `.github/workflows`, профиль сборки Visual Studio и `README.md`; `context.md`, `README.txt`, `AGENTS.md` и агентские правила остаются локально. Публиковать их можно только по явному запросу или при строгой необходимости для публичной сборки.[/I]
