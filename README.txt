...
[*]Рендер оружия кеширует найденные и отсутствующие `Weapons\<skin>.ini`, чтобы не сканировать папку каждый кадр.
...
[*]Привязка custom skins по нику использует кеш `nick -> skin`, с обновлением при рескане/сохранении и live-правках.
