...
void ApplyOrcOutfitStyle(const ImVec2& displaySize) {
    ...
    st.PopupBorderSize = 2.0f;
    st.FramePadding = ImVec2(5.0f, 3.0f);
    st.FrameRounding = 4.0f;
    st.FrameBorderSize = 2.0f;
    st.ItemSpacing = ImVec2(5.0f, 4.0f);
    st.ItemInnerSpacing = ImVec2(3.0f, 3.0f);
    st.CellPadding = ImVec2(4.0f, 3.0f);
    st.TouchExtraPadding = ImVec2(0.0f, 0.0f);
    st.IndentSpacing = 8.0f;
    ...
    st.ImageRounding = 4.0f;
    st.ImageBorderSize = 1.0f;
    st.TabRounding = 4.0f;
    st.TabBorderSize = 1.5f;
    st.TabBarBorderSize = 1.0f;
    st.TabBarOverlineSize = 1.0f;
    st.TreeLinesSize = 1.0f;
    st.TreeLinesRounding = 4.0f;
    st.DragDropTargetRounding = 4.0f;
    ...
    st.SeparatorTextBorderSize = 3.0f;
    st.SeparatorTextAlign = ImVec2(0.0f, 0.5f);
    st.SeparatorTextPadding = ImVec2(8.0f, st.FramePadding.y);
    ...
    const ImVec4 accent = C(0.47f, 0.60f, 0.80f, 1.00f);
    const ImVec4 accentLight = C(0.62f, 0.72f, 0.92f, 1.00f);

    colors[ImGuiCol_Text] = C(0.90f, 0.92f, 0.97f, 1.00f);
    colors[ImGuiCol_TextDisabled] = C(0.36f, 0.39f, 0.46f, 1.00f);
    colors[ImGuiCol_WindowBg] = C(0.10f, 0.12f, 0.15f, 1.00f);
    colors[ImGuiCol_ChildBg] = C(0.12f, 0.14f, 0.18f, 0.98f);
    colors[ImGuiCol_PopupBg] = C(0.14f, 0.16f, 0.20f, 0.97f);
    colors[ImGuiCol_Border] = C(0.34f, 0.39f, 0.48f, 0.82f);
    colors[ImGuiCol_BorderShadow] = C(0.00f, 0.00f, 0.00f, 0.30f);
    colors[ImGuiCol_FrameBg] = C(0.19f, 0.20f, 0.24f, 1.00f);
    colors[ImGuiCol_FrameBgHovered] = C(0.23f, 0.28f, 0.38f, 1.00f);
    colors[ImGuiCol_FrameBgActive] = C(0.27f, 0.36f, 0.51f, 1.00f);
    colors[ImGuiCol_TitleBg] = C(0.13f, 0.16f, 0.21f, 1.00f);
    colors[ImGuiCol_TitleBgActive] = C(0.19f, 0.22f, 0.28f, 1.00f);
    colors[ImGuiCol_TitleBgCollapsed] = C(0.13f, 0.16f, 0.21f, 0.75f);
    colors[ImGuiCol_MenuBarBg] = C(0.13f, 0.15f, 0.19f, 1.00f);
    colors[ImGuiCol_ScrollbarBg] = C(0.17f, 0.19f, 0.23f, 0.90f);
    colors[ImGuiCol_ScrollbarGrab] = C(0.26f, 0.29f, 0.38f, 0.75f);
    colors[ImGuiCol_ScrollbarGrabHovered] = C(0.34f, 0.39f, 0.48f, 0.90f);
    colors[ImGuiCol_ScrollbarGrabActive] = accent;
    colors[ImGuiCol_CheckMark] = accentLight;
    colors[ImGuiCol_SliderGrab] = accent;
    colors[ImGuiCol_SliderGrabActive] = accentLight;
    colors[ImGuiCol_Button] = C(0.20f, 0.22f, 0.26f, 1.00f);
    colors[ImGuiCol_ButtonHovered] = C(0.34f, 0.39f, 0.48f, 1.00f);
    colors[ImGuiCol_ButtonActive] = accent;
    colors[ImGuiCol_Header] = C(0.22f, 0.26f, 0.34f, 0.78f);
    colors[ImGuiCol_HeaderHovered] = C(0.34f, 0.41f, 0.58f, 0.90f);
    colors[ImGuiCol_HeaderActive] = C(0.47f, 0.60f, 0.80f, 0.96f);
    colors[ImGuiCol_Separator] = C(0.27f, 0.33f, 0.44f, 1.00f);
    colors[ImGuiCol_SeparatorHovered] = accent;
    colors[ImGuiCol_SeparatorActive] = accentLight;
    colors[ImGuiCol_ResizeGrip] = C(0.47f, 0.60f, 0.80f, 0.25f);
    colors[ImGuiCol_ResizeGripHovered] = C(0.47f, 0.60f, 0.80f, 0.67f);
    colors[ImGuiCol_ResizeGripActive] = C(0.62f, 0.72f, 0.92f, 0.95f);
    colors[ImGuiCol_InputTextCursor] = accentLight;
    colors[ImGuiCol_Tab] = C(0.15f, 0.17f, 0.21f, 1.00f);
    colors[ImGuiCol_TabHovered] = C(0.34f, 0.39f, 0.48f, 0.90f);
    colors[ImGuiCol_TabSelected] = accent;
    colors[ImGuiCol_TabSelectedOverline] = accentLight;
    colors[ImGuiCol_TabDimmed] = C(0.13f, 0.14f, 0.17f, 1.00f);
    colors[ImGuiCol_TabDimmedSelected] = C(0.16f, 0.20f, 0.29f, 1.00f);
    colors[ImGuiCol_TabDimmedSelectedOverline] = C(0.47f, 0.60f, 0.80f, 0.70f);
    colors[ImGuiCol_PlotLines] = accent;
    colors[ImGuiCol_PlotLinesHovered] = accentLight;
    colors[ImGuiCol_PlotHistogram] = accent;
    colors[ImGuiCol_PlotHistogramHovered] = accentLight;
    colors[ImGuiCol_TableHeaderBg] = C(0.14f, 0.17f, 0.22f, 1.00f);
    colors[ImGuiCol_TableBorderStrong] = C(0.24f, 0.29f, 0.38f, 1.00f);
    colors[ImGuiCol_TableBorderLight] = C(0.17f, 0.20f, 0.25f, 1.00f);
    colors[ImGuiCol_TableRowBg] = C(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_TableRowBgAlt] = C(1.00f, 1.00f, 1.00f, 0.035f);
    colors[ImGuiCol_TextLink] = accent;
    colors[ImGuiCol_TextSelectedBg] = C(0.47f, 0.60f, 0.80f, 0.35f);
    colors[ImGuiCol_TreeLines] = C(0.27f, 0.33f, 0.44f, 0.72f);
    colors[ImGuiCol_DragDropTarget] = accent;
    colors[ImGuiCol_DragDropTargetBg] = C(0.47f, 0.60f, 0.80f, 0.16f);
    colors[ImGuiCol_UnsavedMarker] = accentLight;
    colors[ImGuiCol_NavCursor] = accent;
    colors[ImGuiCol_NavWindowingHighlight] = C(0.47f, 0.60f, 0.80f, 0.70f);
    colors[ImGuiCol_NavWindowingDimBg] = C(0.15f, 0.18f, 0.22f, 0.20f);
    colors[ImGuiCol_ModalWindowDimBg] = C(0.15f, 0.18f, 0.22f, 0.70f);
