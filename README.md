...
| SA:MP | Опционально; расширенная интеграция зависит от версии `samp.dll` |
...
- Плагин ориентирован на **GTA SA 1.0 US** и **x86**.
- Для неизвестных версий `samp.dll` поведение в SA:MP может быть ограничено.
