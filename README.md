...
- Замена моделей и текстур оружия (включая сценарии для SA:MP); ручной рескан замены перечитывает `Guns` / `GunsNick` и заново выбирает random-варианты для уже известных ped.
